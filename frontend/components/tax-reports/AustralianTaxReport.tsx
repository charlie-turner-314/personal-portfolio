...
export function AustralianTaxReport({ report, availableFinancialYears, onFinancialYearChange, financialYearPath, onDownload, downloadDisabled }: AustralianTaxReportProps) {
